...
```{r}
filter_heritage_schools_race <- heritage_schools_crosswalk %>%
  select(sch_name, statename, pct_blk, total, bl, wh, tr, hi, hp, as, am) %>%
  filter(heritage_sch_name ="Lanier Senior High Sch")
