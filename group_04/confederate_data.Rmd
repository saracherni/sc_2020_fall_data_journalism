...
```{r}
#Three schools in Montgomery, Alabama have a rename pending status. There are four schools total with a rename pending status, the last one is located in Texas. Three of the schools were dedicated during the the civil rights era.
...
```{r}
#10 schools have over a 90% Black student body
