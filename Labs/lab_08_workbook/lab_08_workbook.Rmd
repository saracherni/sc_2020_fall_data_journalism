...
##The column names for opioid involved death and prescrpition is construed, needs to be shortened. Blank row in middle, character columns 
```
...
opioid_scrape_clean <- opioid_scrape %>%
  clean_names() %>%
  rename(opioid_death_rate = opioid_involved_overdose_deaths_100_000_persons1_2018)  %>%
  rename(opioid_presciption_rate = opioid_prescriptions_100_persons2_2018)
