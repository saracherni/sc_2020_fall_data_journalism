...
# Write your code to answer the question below by creating a new object.
 covid_maryland_jun_aug_pct_change <- covid_county_monthly_death_rate %>%
...
```
# A: Jones, Texas,  0.4912718 % change
...
# Question: Which county in Florida had the largest increase in COVID-19 cases between May and July?

```{r}
  covid_florida_may_jul_change <- covid_county_monthly_case_rate %>%
    select(county, state, d_2020_05_30, d_2020_07_30) %>%
    filter(state == "Florida") %>%
    mutate(may_jul_change = (d_2020_07_30 - d_2020_05_30)) %>%
    arrange(desc(may_jul_change))
  
```

# A: Miami Dade, Florida 
