...
Mccormack_board_disposition_Unsub <- allegations_NYPD %>%
  select(last_name, allegation, board_disposition) %>%
  filter(last_name == "Mccormack") %>%
...
Mccormack_board_disposition_Unsub

Mccormack_board_disposition_Exon <- allegations_NYPD %>%
  select(last_name, allegation, board_disposition) %>%
  filter(last_name == "Mccormack") %>%
  filter(board_disposition == "Exonerated") %>%
  arrange(board_disposition)

Mccormack_board_disposition_Exon

Mccormack_board_disposition_Unfound <- allegations_NYPD %>%
  select(last_name, allegation, board_disposition) %>%
  filter(last_name == "Mccormack") %>%
  filter(board_disposition == "Unfounded") %>%
  arrange(board_disposition)

Mccormack_board_disposition_Unfound


disposition <- allegations_NYPD %>%
...
Dep_inspector_ranking_misconduct <- allegations_NYPD %>%
  select(last_name, rank_now, allegation, board_disposition) %>%
  filter(rank_now == "Deputy Inspector") %>%
  filter(board_disposition == "Substantiated (Charges)") %>%
  arrange(last_name)
Dep_inspector_ranking_misconduct

Chief_ranking_misconduct <- allegations_NYPD %>%
  select(last_name, rank_now, allegation, board_disposition) %>%
  filter(rank_now == "Chiefs and other ranks") %>%
  filter(board_disposition == "Substantiated (Charges)") %>%
  arrange(last_name)

Chief_ranking_misconduct
